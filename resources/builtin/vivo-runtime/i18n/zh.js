...
module.exports = {
    ...
    not_install_nodejs_windows_error: '导出 vivo小游戏 工程目录完成，由于您未安装或未配置nodejs环境变量，无法构建rpk包！',
    not_install_nodejs_mac_error: '导出 vivo小游戏 工程目录完成，由于您未安装nodejs，无法构建rpk包！',
    ...
    not_install_nodejs_windows_error_before_preview: '预览需要安装并配置nodejs环境或自定义npm路径！',
    not_install_nodejs_mac_error_before_preview: '预览需要安装并配置nodejs环境或填写自定义npm路径!',
