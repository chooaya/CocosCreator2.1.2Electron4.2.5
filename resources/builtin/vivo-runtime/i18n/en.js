...
module.exports = {
    ...
    support_min_platform_hint: 'Enter the minimum supported platform version number, such as: 1030',
    ...
    small_packet_mode: 'Small packet Mode',
    small_packet_path: 'Small Packet Mode Server Path',
    small_packet_path_hint: 'Server address where the resource is stored',
    ...
    custom_manifest_data_error: 'Custom manifest data is not in json format, and packaging will not contain custom manifest data.',

    zip_file_error: 'Compression failed! error:',
    install_nodejs_before_build_rpk: 'Packing rpk requires nodejs, please install nodejs',
    begin_install_npm: 'Start installing the npm package that the game depends on, please be patient...',

    npm_installed_success: 'The npm package that the fast game relies on is installed!',
    npm_install_fail: 'The npm package installation that the fast game relies on fails! error:',
    ...
    not_mainfest_data: 'There is currently no custom mainfest file path, the build will not contain custom mainfest data',
    ...
    not_install_nodejs_windows_error: 'Export Vivo game The project directory is complete. Since you have not installed or configured the nodejs environment variable, you cannot build the rpk package!',
    not_install_nodejs_mac_error: 'Export Vivo game The project directory is complete. Since you have not installed nodejs, you cannot build the rpk package!',

    installing_npm_network: 'Start installing the npm package that the game depends on, please be patient... (requires network)',
    ...
    custom_npm_path_config: "The custom npm path is not empty, and the npm path will be configured with a custom npm path:",
    custom_npm_path_not_config: "No custom npm path configured, npm path will use system environment variable path",

    custom_npm_path_config_error: "Custom npm path error, reselect",

    qr_code_generating: "QR code is being generated, please wait",
    debug_scan_qr_code: "Open the scan installation of the fast application debugger, you can debug",

    buidBeforePreview: "Before you preview, please complete the build in the build panel.",

    not_install_nodejs_windows_error_before_preview: 'Preview needs to install and configure the nodejs environment or custom npm path!',
    not_install_nodejs_mac_error_before_preview: 'Preview needs to install and configure the nodejs environment or custom npm path!',
};
