...
module.exports = {
    ...
    support_min_platform_hint: 'Enter the minimum supported platform version number, such as: 1011',
    ...
    npm_installed_success: 'The npm package that the min game relies on is installed!',
    npm_install_fail: 'The npm package installation that the min game relies on fails! error:',

    rpk_installing: 'Start building rpk packages...',
    rpk_install_fail: 'rpk package build failed! error:',
    rpk_install_success: 'The rpk package is built and the location is generated:',
    ...
    build_subpack_rpk_error: "building sub-package rpk failed! error:",
    build_subpack_rpk_complet: "building sub-package rpk is completed! position:",

    package_name_error: "Please enter the correct package name: start with a letter and cannot contain characters -",
    ...
    select_save_certificate_path: 'Please choose the path to save the certificate',
    ...
    not_install_nodejs_windows_error: "The system environment variable node path is incorrect. Please configure the system environment variable or customize the node path",
    not_install_nodejs_mac_error: "The read default node path is not found in /usr/local/bin/,please configure custom node folder path",
