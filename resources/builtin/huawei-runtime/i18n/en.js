...
module.exports = {
    platform_name: 'Huawei Fast Game',
    ...
    support_min_platform_hint: 'Enter the minimum supported platform version number, such as: 1035',
    ...
    custom_npm_path_config: "The custom node path is not empty, and the node path will be configured with a custom node path:",
    custom_npm_path_not_config: "No custom node path configured, node path will use system environment variable path",

    custom_npm_path_config_error: "Custom node path error, reselect",
    window_default_npm_path_error: "The system environment variable node folder path is incorrect. Please configure the system environment variable or customize the node path",
    mac_default_npm_path_error: "The read default node path is not found in /usr/local/bin/,please configure custom node folder path",

    choose_json_file: "Select the json file",
    choose_image: "Choose picture",

    select_certificate_path: "To view the certificate fingerprint, please select the certificate epath path first",
    install_nodejs_before_view_certificate: "Nodejs is required to view certificate fingerprints, please install nodejs or configure a custom NPM path",
    select_certificate_path_after_view_certificate: "To view the certificate fingerprint error, select the correct certificate epath path",
